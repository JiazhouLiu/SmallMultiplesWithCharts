...
public class Bezier3PointCurve : MonoBehaviour {
    ...
    void Start () {
        ...
        for (int i = 0; i < smCount; i++) {
			smallMultiples.Add (GameObject.Find ("Building " + (i + 1)));
        }
    ...
    void CheckTopRow (){
		GameObject BuildingOne = GameObject.Find("Building 1");
    ...
    void GetPointList() {
        ...
        //{
            //Debug.Log(centerZDelta);
            Vector3 parentScale = this.transform.parent.localScale;
            float scaleZ = 1 / this.transform.parent.localScale.z;
    ...
    void GetCurrentRowSM() {
        ...
        {
            sm.Add(GameObject.Find("Building " + (l + 1)));
        }
